...
# Modifications copyright (c) 2021 Kwai AI Platform and DS3 Lab.  All rights reserved.
#
...
def train(args, train_dataset, model, tokenizer):
    ...
    for _ in train_iterator:
        epoch_iterator = tqdm(
            train_dataloader, desc="Iteration", disable=hvd.rank() != 0
        )
        for step, batch in enumerate(epoch_iterator):
            ...
            if (step + 1) % args.gradient_accumulation_steps == 0:
                ...
                if (
                    ...
                    if not args.distributed and args.evaluate_during_training:
...
def main():
    ...
    if args.distributed and hvd.rank() != 0:
